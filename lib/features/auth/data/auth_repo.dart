...
import 'package:fast_food/features/auth/data/user_model.dart';
...
class AuthRepo {
  ...
  Future<UserModel?> autoLogin() async {
    ...
    try {
      ...
      print(
        '⚠️ Token is valid but profile fetch failed - keeping user logged in',
      );
      // Keep isGuest = false since we have a valid token
      // Return null but maintain the logged-in state
      return null;
    }
  }
